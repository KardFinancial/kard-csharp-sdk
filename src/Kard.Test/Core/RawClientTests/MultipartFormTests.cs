...
namespace Kard.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static Kard.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new Kard.Core.MultipartFormRequest
        {
