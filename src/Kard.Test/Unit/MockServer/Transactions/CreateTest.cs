...
public class CreateTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest_1()
    {
        ...
        var response = await Client.Transactions.CreateAsync(
            ...
            {
                Data = new List<Kard.Transactions>()
                {
                    new Kard.Transactions(
                        new Kard.Transactions.Transaction(
    ...
    public async Task MockServerTest_2()
    {
        ...
        var response = await Client.Transactions.CreateAsync(
            ...
            new TransactionsRequestBody
            {
                ...
                {
                    new Kard.Transactions(
                        new Kard.Transactions.MatchedTransaction(
    ...
    public async Task MockServerTest_4()
    {
        ...
        var response = await Client.Transactions.CreateAsync(
            ...
            new TransactionsRequestBody
            {
                ...
                {
                    new Kard.Transactions(
                        new Kard.Transactions.CoreTransaction(
