...
public class UserResponseObjectTest
{
    ...
    public void TestDeserialization()
    {
        var json = """
            ...
            """;
        var expectedObject = new UserResponseObject
        {
            Data = new UserRequestDataUnion(
        ...
        var deserializedObject = JsonUtils.Deserialize<UserResponseObject>(json);
    ...
    public void TestSerialization()
    {
        var inputJson = """
            ...
            """;
        JsonAssert.Roundtrips<UserResponseObject>(inputJson);
    }
}
