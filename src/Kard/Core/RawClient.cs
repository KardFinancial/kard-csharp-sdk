...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::Kard.Core.ApiResponse> SendRequestAsync(
        global::Kard.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::Kard.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new global::Kard.Core.ApiResponse
            {
    ...
    private string BuildUrl(global::Kard.Core.BaseRequest request)
    {
