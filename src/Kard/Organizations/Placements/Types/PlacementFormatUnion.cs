...
public record PlacementFormatUnion
{
    ...
    /// <summary>
    /// Returns the value as a <see cref="Kard.Organizations.MainPagePlacementData"/> if <see cref="Type"/> is 'placementMainPage', otherwise throws an exception.
    /// </summary>
    /// <exception cref="Exception">Thrown when <see cref="Type"/> is not 'placementMainPage'.</exception>
    public Kard.Organizations.MainPagePlacementData AsPlacementMainPage() =>
        IsPlacementMainPage
            ? (Kard.Organizations.MainPagePlacementData)Value!
            : throw new global::System.Exception(
                "PlacementFormatUnion.Type is not 'placementMainPage'"
            );

    /// <summary>
    /// Returns the value as a <see cref="Kard.Organizations.PushNotificationPlacementData"/> if <see cref="Type"/> is 'placementPushNotification', otherwise throws an exception.
    /// </summary>
    /// <exception cref="Exception">Thrown when <see cref="Type"/> is not 'placementPushNotification'.</exception>
    public Kard.Organizations.PushNotificationPlacementData AsPlacementPushNotification() =>
        IsPlacementPushNotification
            ? (Kard.Organizations.PushNotificationPlacementData)Value!
            : throw new global::System.Exception(
                "PlacementFormatUnion.Type is not 'placementPushNotification'"
            );

    public T Match<T>(
        Func<Kard.Organizations.MainPagePlacementData, T> onPlacementMainPage,
        Func<Kard.Organizations.PushNotificationPlacementData, T> onPlacementPushNotification,
    ...
    public void Visit(
        Action<Kard.Organizations.MainPagePlacementData> onPlacementMainPage,
        Action<Kard.Organizations.PushNotificationPlacementData> onPlacementPushNotification,
    ...
    /// <summary>
    /// Attempts to cast the value to a <see cref="Kard.Organizations.MainPagePlacementData"/> and returns true if successful.
    /// </summary>
    public bool TryAsPlacementMainPage(out Kard.Organizations.MainPagePlacementData? value)
    {
        if (Type == "placementMainPage")
        {
            value = (Kard.Organizations.MainPagePlacementData)Value!;
            return true;
        }
        value = null;
        return false;
    ...
    /// <summary>
    /// Attempts to cast the value to a <see cref="Kard.Organizations.PushNotificationPlacementData"/> and returns true if successful.
    /// </summary>
    public bool TryAsPlacementPushNotification(
        out Kard.Organizations.PushNotificationPlacementData? value
    )
    {
        if (Type == "placementPushNotification")
        {
            value = (Kard.Organizations.PushNotificationPlacementData)Value!;
            return true;
        }
        value = null;
        return false;
    ...
    internal sealed class JsonConverter : JsonConverter<PlacementFormatUnion>
    {
        ...
        )
        {
            ...
            {
                "placementMainPage" =>
                    jsonWithoutDiscriminator.Deserialize<Kard.Organizations.MainPagePlacementData?>(
                        options
                    )
                        ?? throw new JsonException(
                            "Failed to deserialize Kard.Organizations.MainPagePlacementData"
                        ),
                "placementPushNotification" =>
                    jsonWithoutDiscriminator.Deserialize<Kard.Organizations.PushNotificationPlacementData?>(
                        options
                    )
                        ?? throw new JsonException(
                            "Failed to deserialize Kard.Organizations.PushNotificationPlacementData"
                        ),
    ...
    {
        public PlacementMainPage(Kard.Organizations.MainPagePlacementData value)
        {
            Value = value;
        }

        internal Kard.Organizations.MainPagePlacementData Value { get; set; }
    ...
    {
        public PlacementPushNotification(Kard.Organizations.PushNotificationPlacementData value)
        {
            Value = value;
        }

        internal Kard.Organizations.PushNotificationPlacementData Value { get; set; }
