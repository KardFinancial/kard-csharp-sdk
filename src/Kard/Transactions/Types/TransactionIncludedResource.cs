...
public record TransactionIncludedResource
{
    ...
    /// <summary>
    /// Returns the value as a <see cref="Kard.TransactionMerchantResource"/> if <see cref="Type"/> is 'merchant', otherwise throws an exception.
    /// </summary>
    /// <exception cref="Exception">Thrown when <see cref="Type"/> is not 'merchant'.</exception>
    public Kard.TransactionMerchantResource AsMerchant() =>
        IsMerchant
            ? (Kard.TransactionMerchantResource)Value!
            : throw new global::System.Exception(
                "TransactionIncludedResource.Type is not 'merchant'"
            );

    /// <summary>
    /// Returns the value as a <see cref="Kard.TransactionOfferResource"/> if <see cref="Type"/> is 'offer', otherwise throws an exception.
    /// </summary>
    /// <exception cref="Exception">Thrown when <see cref="Type"/> is not 'offer'.</exception>
    public Kard.TransactionOfferResource AsOffer() =>
        IsOffer
            ? (Kard.TransactionOfferResource)Value!
            : throw new global::System.Exception("TransactionIncludedResource.Type is not 'offer'");

    public T Match<T>(
        Func<Kard.TransactionMerchantResource, T> onMerchant,
        Func<Kard.TransactionOfferResource, T> onOffer,
    ...
    public void Visit(
        Action<Kard.TransactionMerchantResource> onMerchant,
        Action<Kard.TransactionOfferResource> onOffer,
    ...
    /// <summary>
    /// Attempts to cast the value to a <see cref="Kard.TransactionMerchantResource"/> and returns true if successful.
    /// </summary>
    public bool TryAsMerchant(out Kard.TransactionMerchantResource? value)
    {
        if (Type == "merchant")
        {
            value = (Kard.TransactionMerchantResource)Value!;
            return true;
        }
        value = null;
        return false;
    ...
    /// <summary>
    /// Attempts to cast the value to a <see cref="Kard.TransactionOfferResource"/> and returns true if successful.
    /// </summary>
    public bool TryAsOffer(out Kard.TransactionOfferResource? value)
    {
        if (Type == "offer")
        {
            value = (Kard.TransactionOfferResource)Value!;
            return true;
        }
        value = null;
        return false;
    ...
    internal sealed class JsonConverter : JsonConverter<TransactionIncludedResource>
    {
        ...
        )
        {
            ...
            {
                "merchant" =>
                    jsonWithoutDiscriminator.Deserialize<Kard.TransactionMerchantResource?>(options)
                        ?? throw new JsonException(
                            "Failed to deserialize Kard.TransactionMerchantResource"
                        ),
                "offer" => jsonWithoutDiscriminator.Deserialize<Kard.TransactionOfferResource?>(
                    options
                ) ?? throw new JsonException("Failed to deserialize Kard.TransactionOfferResource"),
    ...
    {
        public Merchant(Kard.TransactionMerchantResource value)
        {
            Value = value;
        }

        internal Kard.TransactionMerchantResource Value { get; set; }
    ...
    public struct Offer
    {
        public Offer(Kard.TransactionOfferResource value)
        {
            Value = value;
        }

        internal Kard.TransactionOfferResource Value { get; set; }
