...
public record CreateAttributionRequestUnion
{
    ...
    /// <summary>
    /// Returns the value as a <see cref="Kard.Users.OfferAttributionRequest"/> if <see cref="Type"/> is 'offerAttribution', otherwise throws an exception.
    /// </summary>
    /// <exception cref="Exception">Thrown when <see cref="Type"/> is not 'offerAttribution'.</exception>
    public Kard.Users.OfferAttributionRequest AsOfferAttribution() =>
        IsOfferAttribution
            ? (Kard.Users.OfferAttributionRequest)Value!
            : throw new global::System.Exception(
                "CreateAttributionRequestUnion.Type is not 'offerAttribution'"
            );

    /// <summary>
    /// Returns the value as a <see cref="Kard.Users.NotificationAttributionRequest"/> if <see cref="Type"/> is 'notificationAttribution', otherwise throws an exception.
    /// </summary>
    /// <exception cref="Exception">Thrown when <see cref="Type"/> is not 'notificationAttribution'.</exception>
    public Kard.Users.NotificationAttributionRequest AsNotificationAttribution() =>
        IsNotificationAttribution
            ? (Kard.Users.NotificationAttributionRequest)Value!
            : throw new global::System.Exception(
                "CreateAttributionRequestUnion.Type is not 'notificationAttribution'"
            );

    public T Match<T>(
        Func<Kard.Users.OfferAttributionRequest, T> onOfferAttribution,
        Func<Kard.Users.NotificationAttributionRequest, T> onNotificationAttribution,
    ...
    public void Visit(
        Action<Kard.Users.OfferAttributionRequest> onOfferAttribution,
        Action<Kard.Users.NotificationAttributionRequest> onNotificationAttribution,
    ...
    /// <summary>
    /// Attempts to cast the value to a <see cref="Kard.Users.OfferAttributionRequest"/> and returns true if successful.
    /// </summary>
    public bool TryAsOfferAttribution(out Kard.Users.OfferAttributionRequest? value)
    {
        if (Type == "offerAttribution")
        {
            value = (Kard.Users.OfferAttributionRequest)Value!;
            return true;
        }
        value = null;
        return false;
    ...
    /// <summary>
    /// Attempts to cast the value to a <see cref="Kard.Users.NotificationAttributionRequest"/> and returns true if successful.
    /// </summary>
    public bool TryAsNotificationAttribution(out Kard.Users.NotificationAttributionRequest? value)
    {
        if (Type == "notificationAttribution")
        {
            value = (Kard.Users.NotificationAttributionRequest)Value!;
            return true;
        }
        value = null;
        return false;
    ...
    internal sealed class JsonConverter : JsonConverter<CreateAttributionRequestUnion>
    {
        ...
        )
        {
            ...
            {
                "offerAttribution" =>
                    jsonWithoutDiscriminator.Deserialize<Kard.Users.OfferAttributionRequest?>(
                        options
                    )
                        ?? throw new JsonException(
                            "Failed to deserialize Kard.Users.OfferAttributionRequest"
                        ),
                "notificationAttribution" =>
                    jsonWithoutDiscriminator.Deserialize<Kard.Users.NotificationAttributionRequest?>(
                        options
                    )
                        ?? throw new JsonException(
                            "Failed to deserialize Kard.Users.NotificationAttributionRequest"
                        ),
    ...
    {
        public OfferAttribution(Kard.Users.OfferAttributionRequest value)
        {
            Value = value;
        }

        internal Kard.Users.OfferAttributionRequest Value { get; set; }
    ...
    {
        public NotificationAttribution(Kard.Users.NotificationAttributionRequest value)
        {
            Value = value;
        }

        internal Kard.Users.NotificationAttributionRequest Value { get; set; }
