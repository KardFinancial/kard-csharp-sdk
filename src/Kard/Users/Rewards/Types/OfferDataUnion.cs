...
public record OfferDataUnion
{
    ...
    /// <summary>
    /// Returns the value as a <see cref="Kard.Users.StandardOffer"/> if <see cref="Type"/> is 'standardOffer', otherwise throws an exception.
    /// </summary>
    /// <exception cref="Exception">Thrown when <see cref="Type"/> is not 'standardOffer'.</exception>
    public Kard.Users.StandardOffer AsStandardOffer() =>
        IsStandardOffer
            ? (Kard.Users.StandardOffer)Value!
            : throw new global::System.Exception("OfferDataUnion.Type is not 'standardOffer'");

    public T Match<T>(
        Func<Kard.Users.StandardOffer, T> onStandardOffer,
    ...
    public void Visit(
        Action<Kard.Users.StandardOffer> onStandardOffer,
    ...
    /// <summary>
    /// Attempts to cast the value to a <see cref="Kard.Users.StandardOffer"/> and returns true if successful.
    /// </summary>
    public bool TryAsStandardOffer(out Kard.Users.StandardOffer? value)
    {
        if (Type == "standardOffer")
        {
            value = (Kard.Users.StandardOffer)Value!;
            return true;
        }
        value = null;
        return false;
    ...
    internal sealed class JsonConverter : JsonConverter<OfferDataUnion>
    {
        ...
        )
        {
            ...
            {
                "standardOffer" => jsonWithoutDiscriminator.Deserialize<Kard.Users.StandardOffer?>(
                    options
                ) ?? throw new JsonException("Failed to deserialize Kard.Users.StandardOffer"),
    ...
    {
        public StandardOffer(Kard.Users.StandardOffer value)
        {
            Value = value;
        }

        internal Kard.Users.StandardOffer Value { get; set; }
