...
namespace KardApi.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static KardApi.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new KardApi.Core.MultipartFormRequest
        {
