...
namespace KardApi.Test.Unit.MockServer.Files;
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithParam("page[size]", "5")
                    .WithParam("filter[dateFrom]", "2025-02-20T21:56:23Z")
                    .WithParam("filter[dateTo]", "2025-03-20T21:56:23Z")
                    .WithParam("filter[fileType]", "earnedRewardApprovedDailyReconciliationFile")
