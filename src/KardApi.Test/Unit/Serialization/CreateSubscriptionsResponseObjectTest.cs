...
public class CreateSubscriptionsResponseObjectTest
{
    ...
    public void TestDeserialization()
    {
        var json = """
            ...
            """;
        var expectedObject = new CreateSubscriptionsResponseObject
        {
            Data = new List<CreateSubscriptionUnion>()
            {
                new CreateSubscriptionUnion(
        ...
        var deserializedObject = JsonUtils.Deserialize<CreateSubscriptionsResponseObject>(json);
    ...
    public void TestSerialization()
    {
        var inputJson = """
            ...
            """;
        JsonAssert.Roundtrips<CreateSubscriptionsResponseObject>(inputJson);
    }
}
