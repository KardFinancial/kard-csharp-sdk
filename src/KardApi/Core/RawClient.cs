...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::KardApi.Core.ApiResponse> SendRequestAsync(
        global::KardApi.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::KardApi.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new global::KardApi.Core.ApiResponse
            {
    ...
    private string BuildUrl(global::KardApi.Core.BaseRequest request)
    {
