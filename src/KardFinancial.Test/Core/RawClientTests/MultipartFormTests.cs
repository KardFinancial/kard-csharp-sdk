...
namespace KardFinancial.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static KardFinancial.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new KardFinancial.Core.MultipartFormRequest
        {
