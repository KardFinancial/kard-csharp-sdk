...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::KardFinancial.Core.ApiResponse> SendRequestAsync(
        global::KardFinancial.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::KardFinancial.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new global::KardFinancial.Core.ApiResponse
            {
    ...
    private string BuildUrl(global::KardFinancial.Core.BaseRequest request)
    {
